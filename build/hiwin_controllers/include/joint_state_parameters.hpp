#pragma message("#include \"joint_state_parameters.hpp\" is deprecated. Use #include <hiwin_controllers/joint_state_parameters.hpp> instead.")
...
namespace joint_state_parameters {
...
[[nodiscard]] auto to_parameter_value(rsl::StaticVector<T, capacity> const& value) {
    ...
    struct Params {
        ...
        std::vector<std::string> state_interfaces = {"position"};
  ...
  public:
    ...
    : ParamListener(parameters_interface, rclcpp::get_logger("joint_state_parameters"), prefix) {
    ...
    rcl_interfaces::msg::SetParametersResult update(const std::vector<rclcpp::Parameter> &parameters) {
      ...
      for (const auto &param: parameters) {
        ...
        if (param.get_name() == (prefix_ + "command_interfaces")) {
            ...
            if(auto validation_result = subset_of<std::string>(param, {"reset_fault"});
              !validation_result) {
                return rsl::to_parameter_result_msg(validation_result);
            }
        ...
        if (param.get_name() == (prefix_ + "state_interfaces")) {
            ...
            if(auto validation_result = subset_of<std::string>(param, {"position", "velocity"});
              !validation_result) {
                return rsl::to_parameter_result_msg(validation_result);
            }
    ...
    void declare_params(){
      ...
      if (!parameters_interface_->has_parameter(prefix_ + "state_interfaces")) {
          rcl_interfaces::msg::ParameterDescriptor descriptor;
          descriptor.description = "State interfaces to read from the hardware interface for all joints";
          descriptor.read_only = true;
