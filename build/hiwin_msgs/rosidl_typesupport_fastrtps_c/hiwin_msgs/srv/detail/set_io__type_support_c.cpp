...
#include "hiwin_msgs/srv/detail/set_io__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // interface_name, io_group
#include "rosidl_runtime_c/string_functions.h"  // interface_name, io_group

// forward declare type support functions


using _SetIO_Request__ros_msg_type = hiwin_msgs__srv__SetIO_Request;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: io_group
  {
    const rosidl_runtime_c__String * str = &ros_message->io_group;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: io_group
  {
    std::string tmp;
    cdr >> tmp;
    if (!ros_message->io_group.data) {
      rosidl_runtime_c__String__init(&ros_message->io_group);
    }
    bool succeeded = rosidl_runtime_c__String__assign(
      &ros_message->io_group,
      tmp.c_str());
    if (!succeeded) {
      fprintf(stderr, "failed to assign string into field 'io_group'\n");
      return false;
    }
  }
...
size_t get_serialized_size_hiwin_msgs__srv__SetIO_Request(
  const void * untyped_ros_message,
...
static uint32_t _SetIO_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_hiwin_msgs__srv__SetIO_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_hiwin_msgs
size_t max_serialized_size_hiwin_msgs__srv__SetIO_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = hiwin_msgs__srv__SetIO_Request;
    is_plain =
      (
...
static size_t _SetIO_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_hiwin_msgs__srv__SetIO_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, hiwin_msgs, srv, SetIO_Request)() {
...
using _SetIO_Response__ros_msg_type = hiwin_msgs__srv__SetIO_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_hiwin_msgs
size_t get_serialized_size_hiwin_msgs__srv__SetIO_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetIO_Response__ros_msg_type * ros_message = static_cast<const _SetIO_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_hiwin_msgs__srv__SetIO_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_hiwin_msgs
size_t max_serialized_size_hiwin_msgs__srv__SetIO_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = hiwin_msgs__srv__SetIO_Response;
    is_plain =
      (
...
static size_t _SetIO_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_hiwin_msgs__srv__SetIO_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, hiwin_msgs, srv, SetIO_Response)() {
...
// already included above
// #include "hiwin_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "hiwin_msgs/srv/set_io.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, hiwin_msgs, srv, SetIO)() {
