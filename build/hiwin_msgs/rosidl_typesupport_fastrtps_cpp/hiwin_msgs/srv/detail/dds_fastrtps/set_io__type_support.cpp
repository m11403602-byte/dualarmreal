...
#include "hiwin_msgs/srv/detail/set_io__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const hiwin_msgs::srv::SetIO_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: io_group
  cdr << ros_message.io_group;
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  hiwin_msgs::srv::SetIO_Request & ros_message)
{
  // Member: io_group
  cdr >> ros_message.io_group;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = hiwin_msgs::srv::SetIO_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const hiwin_msgs::srv::SetIO_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<hiwin_msgs::srv::SetIO_Request *>(
    untyped_ros_message);
...
{
  return &hiwin_msgs::srv::typesupport_fastrtps_cpp::_SetIO_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, hiwin_msgs, srv, SetIO_Request)() {
  return &hiwin_msgs::srv::typesupport_fastrtps_cpp::_SetIO_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_hiwin_msgs
cdr_serialize(
  const hiwin_msgs::srv::SetIO_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  hiwin_msgs::srv::SetIO_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = hiwin_msgs::srv::SetIO_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const hiwin_msgs::srv::SetIO_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<hiwin_msgs::srv::SetIO_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &hiwin_msgs::srv::typesupport_fastrtps_cpp::_SetIO_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, hiwin_msgs, srv, SetIO_Response)() {
  return &hiwin_msgs::srv::typesupport_fastrtps_cpp::_SetIO_Response__handle;
}
...
{
  return &hiwin_msgs::srv::typesupport_fastrtps_cpp::_SetIO__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, hiwin_msgs, srv, SetIO)() {
  return &hiwin_msgs::srv::typesupport_fastrtps_cpp::_SetIO__handle;
}
