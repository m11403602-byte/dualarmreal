...
class SetIO_Request(metaclass=Metaclass_SetIO_Request):
    ...
    def __init__(self, **kwargs):
        ...
        self.io_group = kwargs.get('io_group', str())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.io_group != other.io_group:
            return False
    ...
    def io_group(self, value):
        if __debug__:
            assert \
                ...
                "The 'io_group' field must be of type 'str'"
...
class Metaclass_SetIO(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from hiwin_msgs.srv import _set_io
...
class SetIO(metaclass=Metaclass_SetIO):
    from hiwin_msgs.srv._set_io import SetIO_Request as Request
    from hiwin_msgs.srv._set_io import SetIO_Response as Response
