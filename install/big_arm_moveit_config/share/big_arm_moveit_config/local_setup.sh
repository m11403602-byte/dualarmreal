...
: ${AMENT_CURRENT_PREFIX:="/home/dualarm/hiwin_ws/install/big_arm_moveit_config"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/big_arm_moveit_config/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/big_arm_moveit_config/environment/path.sh"
